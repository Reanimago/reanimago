(function($, _){
	 ...
	 * @external "jQuery.fn"
	 * @see {@link https://learn.jquery.com/plugins/basic-plugin-creation/|How to Create a Basic Plugin | jQuery Learning Center}
	 */
...
(function (_, _is) {
   ...
   *
   * console.log( _url.parts( "https://example.com/path/?param=true#something" ) ); // => {"hash":"#something", ...}
   */


  _.url.parts = function (url) {
    _a.href = url;
    var port = _a.port ? _a.port : ["https:", "https:"].indexOf(_a.protocol) !== -1 ? _a.protocol === "https:" ? "443" : "80" : "",
   ...
   * var _url = FooGallery.utils.url;
   *
   * console.log( _url.full( "https://example.com/path/" ) ); // => "https://example.com/path/"
...
(function (_, _is, _fn) {
   ...
   * console.log( _str.join( "/", "https://", "/example.com/", "/path/to/image.png" ) ); // => "https://example.com/path/to/image.png"
   * console.log( _str.join( "/", "https://", "/example.com", "/path/to/image.png" ) ); // => "https://example.com/path/to/image.png"
   * console.log( _str.join( "/", "https://", "example.com", "path/to/image.png" ) ); // => "https://example.com/path/to/image.png"
   */
...
(function($, _, _utils, _is){
	 ...
	 * @borrows FooGallery.utils.Class.extend as extend
	 * @borrows FooGallery.utils.Class.override as override
	 * @description This template makes use of the popular [Masonry library](https://masonry.desandro.com/) to perform its layout. It supports two basic layout types, fixed and column based.
	 */
